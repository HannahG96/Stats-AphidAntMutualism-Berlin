...
datawd<-"C:/Hannah/Bachelorarbeit/BA Publication/Rstats/data"
#scripts-working directory:
scriptwd<-"C:/Hannah/Bachelorarbeit/BA Publication/Rstats/scripts/relevant scripts"
#model results-working directory:
modelresultswd<-"C:/Hannah/Bachelorarbeit/BA Publication/Rstats/model results"
...
source("exhaustive_modelselection.R")

#BEST MODELS: CALCULATE STATISTICS
source("bestmodels.R")
